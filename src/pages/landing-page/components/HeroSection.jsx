  ...
  const HeroSection = () => {
    ...
    const navigate = useNavigate(); // ✅ Must be here, not inside a function
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-5 lg:px-8 text-center">
          ...
          >
            ...
            {/* Login Button */}
            <div className="mt-6">
              <button onClick={handleLoginClick} className="px-5 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-all">
                Go to Login
              </button>
            </div>
